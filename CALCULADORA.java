...
public class CALCULADORA extends javax.swing.JFrame {
    ...
    public static String Operacion(String Numero1, String Signo, String Numero2){
        ...
        if(Signo.equals("^")){
            total= Math.pow(Double.parseDouble(Numero1), Double.parseDouble(Numero2));
        }
        if(Signo.equals("raiz") ){
            total= Math.sqrt(Double.parseDouble(Numero1));
        }
        if(Signo.equals("sen")){
            total= Math.sin(Double.parseDouble(Numero1));
        }
        if(Signo.equals("cos")){
            total= Math.cos(Double.parseDouble(Numero1));
        }
        if(Signo.equals("tan")){
            total= Math.tan(Double.parseDouble(Numero1));
        }
        if(Signo.equals("IVA")){
